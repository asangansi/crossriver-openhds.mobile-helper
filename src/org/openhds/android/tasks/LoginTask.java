...
/**
 * The Login task will verify a local user exists in the database
 * If no user exist, the user must initially make a request to download forms
 * with the typed in username/password. If successfully
 */
public class LoginTask extends AsyncTask<Boolean, Void, LoginTask.Result> {
	...
	public LoginTask(PersistentStore storage, String user, String password, Listener listener) {
